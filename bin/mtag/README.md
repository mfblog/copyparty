...
* to delete tags for just one folder and rescan that, `sqlite3 /home/jaycore/hist/pub/up2k.db "delete from mt where w in (select substr(w,1,16) from up where rd like 'blog%')";`
